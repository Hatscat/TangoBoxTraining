...
/// </summary>
public class MotionPointCloud : MonoBehaviour, ITangoDepth
{
    /// <summary>
        ...
        if (tangoDepth != null && tangoDepth.m_points != null)
        {
            ...
            if (m_pointsCount > 0)
            {
                ...
                for (int i = 0; i < m_pointsCount; ++i)
                {
					...
					if (m_previous_points != null  && m_visible_points.Count < MAX_POINT_COUNT)// && IsV3Uniq(m_points[i], m_visible_points))
					{
